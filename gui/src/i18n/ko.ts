...
"common.discard": "버리기",
  ...
  "auth.adminTokenDesc": "계속하려면 OPENCODEX_ADMIN_AUTH_TOKEN을 입력하세요. 브라우저에서 다음 방문을 위해 저장할 수 있습니다.",
  "auth.adminTokenPlaceholder": "관리자 토큰을 붙여넣으세요",
  "auth.adminTokenShow": "표시",
  "auth.adminTokenHide": "숨기기",
  ...
  "dash.activity.title": "30일 활동",
  "dash.activity.requests": "요청",
  "dash.activity.tokens": "토큰",
  "dash.activity.chartLabel": "30일 활동입니다. 왼쪽과 오른쪽 화살표로 날짜를 선택하고 Home과 End로 범위 끝으로 이동합니다.",
  "dash.activity.viewUsage": "사용량 보기",
  ...
  "dash.connectionReconnecting": "연결이 중단되었습니다 — 다시 연결하는 중…",
  ...
  "dash.serverModeLabel": "원격 접속 모드",
  "dash.serverModeLoopback": "루프백 + SSH",
  "dash.serverModeRemote": "원격 TLS",
  "dash.serverModeLoopbackHint": "LAN에 권장. 127.0.0.1을 유지하고 SSH 포워딩으로 연결하므로 인증서 신뢰 설정이 필요 없습니다.",
  "dash.serverModeRemoteHint": "직접 TLS 바인드(0.0.0.0). 신뢰할 수 있는 인증서가 필요합니다.",
  "dash.serverLoopbackCardTitle": "루프백 — SSH 포워딩",
  "dash.serverLoopbackCardDesc": "대시보드를 열 컴퓨터에서 이 임시 터널을 실행하고 터미널을 열어 두세요.",
  "dash.serverLoopbackCardNote": "브라우저에서 포워딩된 HTTP URL을 여세요. SSH가 연결을 암호화합니다. ssh -g는 절대 사용하지 마세요.",
  "dash.serverPersistentTunnelDocs": "영구 macOS 터널 설정",
  "dash.serverRemoteCardTitle": "원격 TLS 바인드",
  "dash.serverRemoteCardDesc": "프록시가 TLS로 모든 인터페이스에서 수신합니다. Codex는 https://<host>:<port>에 직접 연결합니다. 인증서는 Codex 머신(rustls)에서 신뢰되어야 하며, 자체 서명 인증서는 설치될 때까지 UnknownIssuer가 표시됩니다.",
  "dash.serverRemoteSanHint": "인증서 SAN에는 publicOrigin의 호스트 이름 또는 IP가 포함되어야 합니다. 신뢰할 수 있는 CA를 사용하거나 Codex 머신에 프라이빗 CA를 설치하세요.",
  "dash.serverAdvanced": "고급(호스트 이름)",
  "dash.serverCopyUnavailable": "복사할 수 없음",
  "dash.serverRemoteCredentialRequired": "원격 TLS를 활성화하기 전에 데이터 플레인 API 키를 추가하세요.",
  "dash.serverRestartNotice": "리스너 설정이 저장되었습니다. 적용하려면 프록시를 다시 시작하세요.",
  "dash.serverSettingsTitle": "서버 리스너 설정",
  "dash.serverSaveFailed": "서버 리스너 설정을 저장하지 못했습니다.",
  "dash.serverTlsOff": "꺼짐",
  "dash.serverCredentialConfigured": "설정됨",
  "dash.serverCredentialMissing": "없음",
  "dash.serverRestartRequired": "예",
  ...
  "dash.syncCodexSubagentDefaults": "모델을 생략한 서브에이전트에 사용",
  ...
  "prov.cooldownCleared": "쿨다운이 해제되었습니다",
  "prov.cooldownClearFailed": "쿨다운을 해제하지 못했습니다",
  "prov.accountId": "ID",
  ...
  "models.contextCapLabel": "안전 상한 / 폴백",
  ...
  "models.contextDefault": "안전 상한 / 폴백",
  "models.contextModel": "모델",
  "models.contextModelOverride": "모델별 재정의",
  "models.contextHint": "비워 두면 자동 검색합니다. 여기에 적은 값은 안전 상한이자 폴백입니다. 업스트림 창이 없을 때만 채우고, 더 큰 보고값만 낮춥니다. 라이브 검색 결과는 이 칸에 다시 쓰이지 않습니다.",
  ...
  "models.contextMetadataUnknown": "알 수 없음",
  "models.contextMetadataStale": "오래됨",
  "models.contextTooltipDetected": "{value} · 감지됨",
  "models.contextTooltipCapped": "{detected} 감지됨 · {cap}으로 제한",
  "models.contextTooltipStale": "{value} · {when}",
  "models.contextTooltipUnknown": "컨텍스트 윈도우를 알 수 없음",
  "models.contextTooltipSource": "{value} · {source}",
  "models.contextLastChecked": "마지막 확인 {when}",
  "models.contextYesterday": "어제",
  "models.setAll": "전체 적용",
  ...
  "sub.orderHint": "순서는 {cmd}에 표시되는 모델만 결정하며 기본값이나 폴백 순서는 정하지 않습니다.",
  "sub.orderHintAria": "이 순서가 쓰이는 방식",
  "sub.advanced": "고급",
  "sub.featured": "광고된 오버라이드",
  "sub.noneSelected": "선택된 항목 없음 — 아래 목록에서 선택하세요.",
  "sub.models": "모델",
  "sub.search": "모델 검색(네이티브 gpt + 라우팅)…",
  "sub.settings": "설정",
  "sub.sections": "서브에이전트 구역",
  "sub.delegation.model": "선호하는 서브에이전트 모델",
  "sub.delegation.modelHint": "OpenCodex가 위임에 권장하는 모델입니다. 광고된 오버라이드 순서와는 독립적입니다.",
  ...
  "sub.removeAria": "{m} 삭제",
  "sub.workspace.addToFeatured": "{m}을(를) 광고된 오버라이드에 추가",
  "sub.workspace.allModels": "모든 모델",
  "sub.workspace.featuredFull": "광고된 오버라이드 목록이 가득 찼습니다 (최대 5개)",
  "sub.workspace.mainAria": "서브에이전트 모델 세부 정보",
  "sub.workspace.notFeatured": "추천되지 않음",
  "sub.workspace.priority": "우선순위",
  "sub.workspace.removeFromFeatured": "{m}을(를) 광고된 오버라이드에서 제거",
  ...
  "sub.nativeParentOverride": "네이티브 V2 부모 라우팅",
  "sub.nativeParentOverrideHint": "Codex에는 원래 네이티브 모델이 표시될 수 있지만 OpenCodex는 선택한 라우팅 대상으로 루트를 실행합니다.",
  "sub.nativeParentOverridePrivacyWarning": "프롬프트, 저장소 컨텍스트, 대화 기록, 도구 결과가 선택한 제공업체로 전송되며 해당 제공업체의 가용성, 컨텍스트, 지연 시간, 동작, 비용 및 개인정보 보호 특성을 따릅니다.",
  ...
  "sub.agentTaskRecovery": "암호화된 V2 작업 복구",
  "sub.agentTaskRecoveryHint": "ChatGPT를 통해 OpenAI Fernet 암호화된 작업 메시지를 복호화하여 OpenAI 외 하위 에이전트도 라우팅된 V2 작업을 읽고 실행할 수 있도록 합니다.",
  "sub.agentTaskRecoveryModel": "복구 모델 (기본값: gpt-5.6-luna)",
  "sub.agentTaskRecoveryDefault": "기본 모델 (gpt-5.6-luna)",
  "sub.agentTaskRecoverySaveFail": "암호화된 작업 복구 설정 저장 실패",
  "sub.agentTaskRecoverySaved": "암호화된 작업 복구 설정이 저장되었습니다.",
  "sub.roles": "역할",
  "sub.roles.hint": "부모가 spawn할 수 있는 이름 있는 전문가입니다. 각 역할은 모델과 자식 프롬프트를 고정합니다. 위임 여부는 부모가 결정합니다.",
  "sub.roles.add": "역할 추가",
  "sub.roles.empty": "아직 역할이 없습니다. 리뷰, 검색 등 위임할 작업용 전문가를 추가하세요.",
  "sub.roles.full": "역할 카탈로그가 가득 찼습니다(최대 8)",
  "sub.roles.id": "역할 이름",
  "sub.roles.description": "사용할 때",
  "sub.roles.descriptionHint": "부모가 이 전문가를 언제 spawn할지 알 수 있도록 표시됩니다.",
  "sub.roles.model": "모델",
  "sub.roles.effort": "에포트",
  "sub.roles.effortNone": "모델 기본값",
  "sub.roles.instructions": "자식 지시",
  "sub.roles.instructionsHint": "자식 에이전트가 불러오는 개발자 프롬프트입니다.",
  "sub.roles.enabled": "사용",
  "sub.roles.delete": "역할 {id} 삭제",
  "sub.roles.save": "역할 저장",
  "sub.roles.saved": "역할이 저장되었습니다. 새 Codex 세션부터 적용됩니다.",
  "sub.roles.saveFailed": "역할을 저장하지 못했습니다",
  "sub.roles.loadFail": "역할을 불러오지 못했습니다 — 프록시가 실행 중인가요?",
  "sub.roles.routedV2Warning": "이 역할은 ChatGPT를 v1에 유지하지 않은 v2 표면의 라우팅된 모델을 사용합니다. 네이티브 v2 부모는 자식 작업을 암호화합니다.",
  "sub.roles.sync": "Codex 에이전트 파일로 동기화",
  "sub.roles.syncHint": "사용 중인 역할을 마커 소유 ocx-*.toml에 씁니다. 끄면 OpenCodex 소유 파일만 정리하고 사용자 파일은 건드리지 않습니다.",
  "sub.injectionPrompt": "사용자 지정 부모 안내",
  "sub.injectionPromptHint": "내장 v2 spawn 안내를 바꿉니다. 비우면 기본 문장입니다. 실시간 값이 필요하면 플레이스홀더를 넣으세요:",
  "sub.injectionPromptSave": "부모 안내 저장",
  "sub.injectionPromptSaved": "부모 안내가 저장되었습니다. 새 Codex 세션부터 적용됩니다.",
  "sub.injectionPromptSaveFailed": "부모 안내를 저장하지 못했습니다",
  "sub.childInstructions": "전역 자식 지시",
  "sub.childInstructionsHint": "spawn된 모든 자식에 적용됩니다. 역할 지시는 동기화 후 해당 전문가에만 적용됩니다.",
  "sub.childInstructionsSave": "자식 지시 저장",
  "sub.childInstructionsSaved": "자식 지시가 저장되었습니다. 새 Codex 세션부터 적용됩니다.",
  "sub.childInstructionsSaveFailed": "자식 지시를 저장하지 못했습니다",
  ...
  "logs.filter.provider.label": "제공자",
  "logs.filter.provider.all": "모든 제공자",
 ...
 "logs.filter.conversation.clear": "지우기",
  ...
  "logs.detail.attempt.recovery.cursorEnvelopeEcho": "Cursor 리플레이 엔벨로프 복구",
  "logs.detail.attempt.recovery.cursorRoutingCommentary": "Cursor 라우팅 해설 복구",
  "logs.detail.attempt.recovery.cursorDuplicateToolCall": "Cursor 중복 도구 호출 복구",
  "logs.detail.attempt.recovery.cursorOverflowRemint": "Cursor 오버플로 복구",
  "logs.detail.attempt.recovery.cursorInvalidArgument": "Cursor 잘못된 인수 복구",
...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
  ...
  "anthropicPool.disabledDesc": "세션마다 계정 하나만 사용합니다. 429 장애 조치는 꺼져 있습니다.",
  ...
  "api.workspace.deleteConfirm": "이 키를 삭제하시겠습니까? 이 키를 사용하는 클라이언트는 즉시 액세스를 잃습니다. 되돌릴 수 없습니다.",
  ...
  "replitGateway.title": "Replit 게이트웨이 동반",
  "replitGateway.subtitle": "직접 배포한 Replit 게이트웨이에 연결하고 OpenAI Chat 및 Anthropic 페어 프로바이더를 함께 설치합니다.",
  "replitGateway.companionNote": "이것은 사용자 지정 동반 워크플로이며, 정식 레지스트리 프리셋이 아닙니다.",
  "replitGateway.originLabel": "배포 origin",
  "replitGateway.originHint": "Replit 배포의 HTTPS origin(예: https://my-app.replit.app).",
  "replitGateway.keyLabel": "게이트웨이 키",
  "replitGateway.keyHint": "배포의 REPLIT_GATEWAY_KEY 시크릿입니다. 로컬 프로바이더 구성에 저장되며 게이트웨이 트래픽 인증에 사용됩니다.",
  "replitGateway.keyTooShort": "게이트웨이 키가 너무 짧습니다(최소 32자).",
  "replitGateway.keyTooLong": "게이트웨이 키는 512자 이하여야 합니다.",
  "replitGateway.keyInvalidChars": "게이트웨이 키는 인쇄 가능한 ASCII 문자만 포함해야 합니다.",
  "replitGateway.errorNetwork": "프록시에 연결할 수 없습니다. 실행 중인지 확인한 뒤 다시 시도하세요.",
  "replitGateway.errorMalformed": "프록시가 잘못된 응답을 반환했습니다. 잠시 후 다시 시도하세요.",
  "replitGateway.customDomainLabel": "사용자 지정 도메인 허용",
  "replitGateway.customDomainHint": "게이트웨이가 .replit.app에 호스트되지 않은 경우에만 활성화하세요.",
  "replitGateway.setDefaultLabel": "설치 후 replit을 기본 프로바이더로 설정",
  "replitGateway.install": "페어 설치",
  "replitGateway.installing": "설치 중…",
  "replitGateway.close": "닫기",
  "replitGateway.openButton": "Replit 게이트웨이…",
  "replitGateway.replaceTitle": "기존 Replit 페어를 교체할까요?",
  "replitGateway.replaceBody": "replit 및 replit-anthropic 프로바이더가 이미 있습니다. 교체하면 게이트웨이 origin과 키가 덮어쓰여지지만 오버레이는 유지됩니다.",
  "replitGateway.replaceConfirm": "페어 교체",
  "replitGateway.replaceCancel": "기존 유지",
  "replitGateway.probeHealth": "healthz: HTTP {status} ({ms} ms)",
  "replitGateway.probeModels": "models: {count}개 발견 ({ms} ms)",
  "replitGateway.successTitle": "Replit 게이트웨이 페어를 설치했습니다.",
  "replitGateway.errorGeneric": "Replit 게이트웨이 페어를 설치할 수 없습니다.",
  "replitGateway.errorCollision": "Replit 프로바이더 페어가 이미 있습니다.",
  "replitGateway.errorBusy": "구성이 사용 중입니다. 잠시 후 다시 시도하세요.",
  "replitGateway.originRequired": "배포 origin은 필수입니다.",
  "replitGateway.keyRequired": "게이트웨이 키는 필수입니다.",
  ...
  "modal.catalogLoadFailed": "프로바이더 카탈로그를 불러올 수 없습니다.",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.antigravityTlsTitle": "Antigravity 브라우저 TLS 프로필",
  "pws.antigravityTlsEnable": "실험적 TLS/HTTP2 에뮬레이션 사용",
  "pws.antigravityTlsWarning": "비공식 호환 기능입니다. 서비스 약관 준수나 정지를 보장하지 않으며 트래픽을 더 식별하기 쉽게 만들 수 있고 초기화 실패 시 Bun으로 대체됩니다. 공식 Gemini API 키, Vertex 또는 문서화된 Code Assist 경로가 더 안전합니다.",
  "pws.antigravityTlsConfirm": "실험적이고 비공식적인 Antigravity TLS 프로필을 사용하시겠습니까? 정책 준수나 정지 방지는 보장되지 않습니다. 계속할까요?",
  "pws.antigravityTlsStatus": "TLS 프로필 상태: {status}",
  "pws.antigravityTlsDisabled": "사용 안 함",
  "pws.antigravityTlsActive": "활성",
  "pws.antigravityTlsFallback": "대체 사용",
  "pws.saving": "저장 중…",
  ...
  "pws.aiStudio.connected": "연결됨",
  "pws.aiStudio.checking": "세션 확인 중",
  "pws.aiStudio.unsupported": "이 플랫폼에서는 네이티브 로그인을 지원하지 않습니다",
  "pws.aiStudio.needsReauth": "재인증이 필요합니다",
  "pws.aiStudio.reauthenticated": "재인증에 성공했습니다",
  "pws.aiStudio.loginFailed": "네이티브 로그인에 실패했습니다",
  "pws.aiStudio.connect": "연결",
  "time.justNow": "방금 전",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "claudeDesktop.catalogChanged": "편집하는 동안 모델 카탈로그가 변경되었습니다. 사용할 수 없는 모델을 원래대로 되돌렸습니다. 프로필을 확인한 다음 다시 저장하세요.",
  ...
  "claudeDesktop.mappingDetails": "고급 모델 매핑",
  ...
  "sub.routedDelegationBridgeInactive": "설정됨: 적격 네이티브 V2 루트와 생성된 자식 턴에서 활성화됩니다.",
  ...
  "sub.prefer": "우선 모델로 지정",
  "sub.preferred": "우선 모델",
  "sub.preferredOutsideAdvertised": "선호 모델이 5개의 광고된 오버라이드에 없습니다. 전체 ID로 실행할 수 있으며 자동으로 삽입하지 않습니다.",
  "sub.catalogState.label": "Codex 카탈로그",
  "sub.catalogState.fresh": "최신",
  "sub.catalogState.stale": "오래됨 — Codex를 다시 시작해 모델 피커를 갱신하세요.",
  "sub.catalogState.not_running": "실행 중인 Codex app-server 없음",
  "sub.catalogState.unknown": "알 수 없음",
  "sub.nativeDefaultState.active": "활성: 동기화 후 모델을 생략한 서브에이전트가 이 우선 설정을 사용합니다.",
  "sub.nativeDefaultState.disabled": "모델 생략 동기화가 꺼져 있어 이 우선 설정은 네이티브 기본값이 아닙니다.",
  "sub.nativeDefaultState.pending": "대기 중: 모델 생략 동작을 활성화하려면 동기화 또는 재시작이 필요합니다.",
  "sub.nativeDefaultState.blocked": "차단됨: 사용자 소유 또는 호환되지 않는 Codex 설정이 네이티브 동기화를 막습니다.",
  "logs.filter.agent.label": "에이전트",
  "logs.filter.agent.all": "모두",
  "logs.filter.agent.main": "메인",
  "logs.filter.agent.subagent": "서브에이전트",
  "logs.filter.agent.internal": "내부",
  "logs.filter.agent.unknown": "알 수 없음",
  "logs.agent.main": "메인",
  "logs.agent.subagent": "서브에이전트",
  "logs.agent.internal": "내부",
  "logs.agent.unknown": "알 수 없음",
  "logs.agent.badgeTitle": "요청 출처",
