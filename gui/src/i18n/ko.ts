...
"common.discard": "버리기",
  ...
  "dash.serverLoopbackCardDesc": "프록시는 127.0.0.1에서 대기합니다. 원격 Codex 머신에서는 SSH 터널을 통해 연결하세요.",
  "dash.serverLoopbackCardNote": "Codex 머신에서 openai_base_url을 포워딩된 URL로 설정하고, 설정한 경우 x-opencodex-api-key도 전달하세요. UnknownIssuer를 완전히 피할 수 있습니다.",
