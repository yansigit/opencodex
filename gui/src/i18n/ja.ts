...
"common.discard": "破棄",
  ...
  "auth.adminTokenDesc": "続行するには OPENCODEX_ADMIN_AUTH_TOKEN を入力してください。ブラウザが次回のために保存を提案する場合があります。",
  "auth.adminTokenPlaceholder": "管理者トークンを貼り付け",
  "auth.adminTokenShow": "表示",
  "auth.adminTokenHide": "非表示",
  ...
  "dash.activity.title": "30日間のアクティビティ",
  "dash.activity.requests": "リクエスト",
  "dash.activity.tokens": "トークン",
  "dash.activity.chartLabel": "30日間のアクティビティ。左右キーで日を選択し、Home と End で範囲の端へ移動します。",
  "dash.activity.viewUsage": "使用状況を表示",
  ...
  "dash.connectionReconnecting": "接続が中断されました — 再接続中…",
  ...
  "dash.serverModeLabel": "リモートアクセスモード",
  "dash.serverModeLoopback": "ループバック + SSH",
  "dash.serverModeRemote": "リモート TLS",
  "dash.serverModeLoopbackHint": "LAN 向けの推奨設定。127.0.0.1 のまま SSH ポートフォワーディングで接続するため、証明書の信頼設定は不要です。",
  "dash.serverModeRemoteHint": "直接 TLS バインド（0.0.0.0）。信頼された証明書が必要です。",
  "dash.serverLoopbackCardTitle": "ループバック — SSH ポートフォワーディング",
  "dash.serverLoopbackCardDesc": "ダッシュボードを開くコンピューターでこの一時トンネルを実行し、ターミナルを開いたままにしてください。",
  "dash.serverLoopbackCardNote": "転送された HTTP URL をブラウザーで開きます。接続は SSH で暗号化されます。ssh -g は使用しないでください。",
  "dash.serverPersistentTunnelDocs": "永続的な macOS トンネルの設定",
  "dash.serverRemoteCardTitle": "リモート TLS バインド",
  "dash.serverRemoteCardDesc": "プロキシは TLS で全インターフェースをリッスンします。Codex は https://<host>:<port> に直接接続します。証明書は Codex マシン（rustls）に信頼されている必要があり、自己署名証明書はインストールされるまで UnknownIssuer が表示されます。",
  "dash.serverRemoteSanHint": "証明書の SAN には publicOrigin のホスト名または IP を含める必要があります。信頼された CA を使用するか、Codex マシンにプライベート CA をインストールしてください。",
  "dash.serverAdvanced": "詳細設定（ホスト名）",
  "dash.serverCopyUnavailable": "コピーできません",
  "dash.serverRemoteCredentialRequired": "リモート TLS を有効にする前に、データプレーン API キーを追加してください。",
  "dash.serverRestartNotice": "リスナー設定を保存しました。適用するにはプロキシを再起動してください。",
  "dash.serverSettingsTitle": "サーバーリスナー設定",
  "dash.serverSaveFailed": "サーバーリスナー設定の保存に失敗しました。",
  "dash.serverTlsOff": "オフ",
  "dash.serverCredentialConfigured": "設定済み",
  "dash.serverCredentialMissing": "未設定",
  "dash.serverRestartRequired": "はい",
  "dash.injectionLabel": "サブエージェント委任",
  "dash.injectionHint": "Codex がサブエージェントに作業を渡すときのモデルを選びます。この選択をどこに適用するかは下の 2 つのスイッチが決めます。",
  "dash.syncCodexSubagentDefaults": "モデル省略サブエージェントに使用",
  ...
  "models.contextCapLabel": "安全上限 / フォールバック",
  ...
  "models.contextDefault": "安全上限 / フォールバック",
  "models.contextModel": "モデル",
  "models.contextModelOverride": "モデル別の上書き",
  "models.contextHint": "空欄のままにすると自動検出します。ここに書いた値は安全上限兼フォールバックで、上流の窓がないときだけ埋め、より大きな報告値だけ下げます。ライブ検出の結果はこの欄に書き戻りません。",
  ...
  "models.contextMetadataUnknown": "不明",
  "models.contextMetadataStale": "古い",
  "models.contextTooltipDetected": "{value} · 検出",
  "models.contextTooltipCapped": "{detected} 検出 · {cap} に制限",
  "models.contextTooltipStale": "{value} · {when}",
  "models.contextTooltipUnknown": "コンテキストウィンドウ不明",
  "models.contextTooltipSource": "{value} · {source}",
  "models.contextLastChecked": "最終確認 {when}",
  "models.contextYesterday": "昨日",
  "models.setAll": "すべて設定",
  ...
  "sub.orderHint": "順序は {cmd} に表示するモデルだけを制御し、既定値やフォールバック順は設定しません。",
  "sub.orderHintAria": "この順序の使われ方",
  "sub.advanced": "詳細設定",
  "sub.featured": "広告するオーバーライド",
  ...
  "sub.workspace.addToFeatured": "{m} を広告するオーバーライドに追加",
  "sub.workspace.allModels": "すべてのモデル",
  "sub.workspace.featuredFull": "広告するオーバーライドのリストがいっぱいです（最大 5）",
  "sub.workspace.mainAria": "サブエージェントのモデル詳細",
  "sub.workspace.notFeatured": "おすすめ未設定",
  "sub.workspace.priority": "優先度",
  "sub.workspace.removeFromFeatured": "{m} を広告するオーバーライドから削除",
  ...
  "sub.nativeParentOverride": "ネイティブ V2 親をルーティング",
  "sub.nativeParentOverrideHint": "Codex には元のネイティブモデルが表示される場合がありますが、OpenCodex は選択したルーティング先でルートを実行します。",
  "sub.nativeParentOverridePrivacyWarning": "プロンプト、リポジトリコンテキスト、会話履歴、ツール結果は選択したプロバイダーに送られ、その可用性、コンテキスト、遅延、動作、コスト、プライバシー特性を引き継ぎます。",
  ...
  "sub.agentTaskRecovery": "暗号化された V2 タスクの復元",
  "sub.agentTaskRecoveryHint": "ChatGPT 経由で OpenAI Fernet 暗号化タスクメッセージを復号し、OpenAI 以外のサブエージェントでも V2 タスクを読み取れるようにします。",
  "sub.agentTaskRecoveryModel": "復元モデル (デフォルト: gpt-5.6-luna)",
  "sub.agentTaskRecoveryDefault": "デフォルトモデル (gpt-5.6-luna)",
  "sub.agentTaskRecoverySaveFail": "暗号化タスク復元の保存に失敗しました",
  "sub.agentTaskRecoverySaved": "暗号化タスク復元の設定を保存しました。",
  "sub.roles": "ロール",
  "sub.roles.hint": "親が spawn できる名前付きスペシャリストです。各ロールはモデルと子プロンプトを固定します。委譲するかどうかは親が決めます。",
  "sub.roles.add": "ロールを追加",
  "sub.roles.empty": "まだロールがありません。レビューや検索など、委譲したい作業用のスペシャリストを追加してください。",
  "sub.roles.full": "ロールカタログがいっぱいです（最大 8）",
  "sub.roles.id": "ロール名",
  "sub.roles.description": "使うタイミング",
  "sub.roles.descriptionHint": "親がこのスペシャリストをいつ spawn すべきか判断するために表示されます。",
  "sub.roles.model": "モデル",
  "sub.roles.effort": "エフォート",
  "sub.roles.effortNone": "モデル既定",
  "sub.roles.instructions": "子の指示",
  "sub.roles.instructionsHint": "子エージェントが読み込むデベロッパープロンプトです。",
  "sub.roles.enabled": "有効",
  "sub.roles.delete": "ロール {id} を削除",
  "sub.roles.save": "ロールを保存",
  "sub.roles.saved": "ロールを保存しました。新しい Codex セッションから適用されます。",
  "sub.roles.saveFailed": "ロールの保存に失敗しました",
  "sub.roles.loadFail": "ロールを読み込めませんでした — プロキシは起動していますか？",
  "sub.roles.routedV2Warning": "このロールは v2 サーフェス上のルーテッドモデルを使い、ChatGPT を v1 に保っていません。ネイティブ v2 の親は子タスクを暗号化します。",
  "sub.roles.sync": "Codex エージェントファイルへ同期",
  "sub.roles.syncHint": "有効なロールをマーカー所有の ocx-*.toml に書き込みます。オフにすると OpenCodex 所有ファイルだけを削除し、あなたのファイルは触りません。",
  "sub.injectionPrompt": "カスタム親ガイダンス",
  "sub.injectionPromptHint": "組み込みの v2 spawn 案内を置き換えます。空なら組み込み文です。ライブ値が必要ならプレースホルダを入れてください:",
  "sub.injectionPromptSave": "親ガイダンスを保存",
  "sub.injectionPromptSaved": "親ガイダンスを保存しました。新しい Codex セッションから適用されます。",
  "sub.injectionPromptSaveFailed": "親ガイダンスの保存に失敗しました",
  "sub.childInstructions": "グローバルな子の指示",
  "sub.childInstructionsHint": "spawn されたすべての子に適用されます。ロール指示は同期後、そのスペシャリストにだけ適用されます。",
  "sub.childInstructionsSave": "子の指示を保存",
  "sub.childInstructionsSaved": "子の指示を保存しました。新しい Codex セッションから適用されます。",
  "sub.childInstructionsSaveFailed": "子の指示の保存に失敗しました",
  ...
  "logs.filter.status.label": "状態",
  "logs.filter.status.all": "すべての状態",
  "logs.filter.status.success": "成功 (2xx)",
  "logs.filter.status.errors": "エラー (4xx/5xx)",
  "logs.filter.time.label": "期間",
  "logs.filter.time.all": "全期間",
  "logs.filter.time.15m": "直近15分",
  "logs.filter.time.1h": "直近1時間",
  "logs.filter.time.24h": "直近24時間",
 ...
 "logs.filter.conversation.clear": "クリア",
  ...
  "logs.detail.attempt.recovery.cursorEnvelopeEcho": "Cursor リプレイエンベロープリカバリ",
  "logs.detail.attempt.recovery.cursorRoutingCommentary": "Cursor ルーティング解説リカバリ",
  "logs.detail.attempt.recovery.cursorDuplicateToolCall": "Cursor 重複ツール呼び出しリカバリ",
  "logs.detail.attempt.recovery.cursorOverflowRemint": "Cursor オーバーフロー復旧",
  "logs.detail.attempt.recovery.cursorInvalidArgument": "Cursor 無効引数復旧",
  ...
  "replitGateway.title": "Replit ゲートウェイコンパニオン",
  "replitGateway.subtitle": "自分でデプロイした Replit ゲートウェイに接続し、OpenAI Chat と Anthropic のペアプロバイダーをまとめてインストールします。",
  "replitGateway.companionNote": "これはカスタムのコンパニオンワークフローであり、正規レジストリのプリセットではありません。",
  "replitGateway.originLabel": "デプロイメントのオリジン",
  "replitGateway.originHint": "Replit デプロイメントの HTTPS オリジン（例: https://my-app.replit.app）。",
  "replitGateway.keyLabel": "ゲートウェイキー",
  "replitGateway.keyHint": "デプロイメントの REPLIT_GATEWAY_KEY シークレット。ローカルのプロバイダー設定に保存され、ゲートウェイ通信の認証に使われます。",
  "replitGateway.keyTooShort": "ゲートウェイキーが短すぎます（最低 32 文字）。",
  "replitGateway.keyTooLong": "ゲートウェイキーは 512 文字以内にしてください。",
  "replitGateway.keyInvalidChars": "ゲートウェイキーは印字可能な ASCII 文字のみ使用できます。",
  "replitGateway.errorNetwork": "プロキシに接続できませんでした。実行中か確認してから再試行してください。",
  "replitGateway.errorMalformed": "プロキシから無効な応答が返されました。しばらくしてから再試行してください。",
  "replitGateway.customDomainLabel": "カスタムドメインを許可",
  "replitGateway.customDomainHint": "ゲートウェイが .replit.app 以外でホストされている場合のみ有効にしてください。",
  "replitGateway.setDefaultLabel": "インストール後に replit を既定プロバイダーに設定",
  "replitGateway.install": "ペアをインストール",
  "replitGateway.installing": "インストール中…",
  "replitGateway.close": "閉じる",
  "replitGateway.openButton": "Replit ゲートウェイ…",
  "replitGateway.replaceTitle": "既存の Replit ペアを置き換えますか？",
  "replitGateway.replaceBody": "プロバイダー replit と replit-anthropic は既に存在します。置き換えるとゲートウェイのオリジンとキーが上書きされますが、オーバーレイは保持されます。",
  "replitGateway.replaceConfirm": "ペアを置き換え",
  "replitGateway.replaceCancel": "既存を保持",
  "replitGateway.probeHealth": "healthz: HTTP {status}（{ms} ms）",
  "replitGateway.probeModels": "models: {count} 件を検出（{ms} ms）",
  "replitGateway.successTitle": "Replit ゲートウェイペアをインストールしました。",
  "replitGateway.errorGeneric": "Replit ゲートウェイペアをインストールできませんでした。",
  "replitGateway.errorCollision": "Replit プロバイダーペアは既に存在します。",
  "replitGateway.errorBusy": "設定がビジーです。しばらくしてから再試行してください。",
  "replitGateway.originRequired": "デプロイメントのオリジンは必須です。",
  "replitGateway.keyRequired": "ゲートウェイキーは必須です。",
  ...
  "modal.catalogLoadFailed": "プロバイダーカタログを読み込めませんでした。",
  ...
  "pws.antigravityTlsTitle": "Antigravity ブラウザー TLS プロファイル",
  "pws.antigravityTlsEnable": "実験的な TLS/HTTP2 エミュレーションを有効化",
  "pws.antigravityTlsWarning": "非公式の互換機能です。利用規約への準拠や停止防止を保証せず、通信をより特徴的にする可能性があり、初期化に失敗すると Bun にフォールバックします。公式の Gemini API キー、Vertex、または文書化された Code Assist ルートの方が安全です。",
  "pws.antigravityTlsConfirm": "実験的で非公式な Antigravity TLS プロファイルを有効にしますか？ポリシー準拠や停止防止は保証されません。続行しますか？",
  "pws.antigravityTlsStatus": "TLS プロファイルの状態: {status}",
  "pws.antigravityTlsDisabled": "無効",
  "pws.antigravityTlsActive": "有効",
  "pws.antigravityTlsFallback": "フォールバック",
  "pws.saving": "保存中…",
  ...
  "pws.aiStudio.connected": "接続済み",
  "pws.aiStudio.checking": "セッションを確認中",
  "pws.aiStudio.unsupported": "このプラットフォームではネイティブログインに対応していません",
  "pws.aiStudio.needsReauth": "再認証が必要です",
  "pws.aiStudio.reauthenticated": "再認証に成功しました",
  "pws.aiStudio.loginFailed": "ネイティブログインに失敗しました",
  "pws.aiStudio.connect": "接続",
  "time.justNow": "たった今",
  "time.notChecked": "未確認",
...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
  ...
  "anthropicPool.disabledDesc": "セッションごとに 1 アカウントのみを使用します。429 フェイルオーバーは無効です。",
  ...
  "api.workspace.deleteConfirm": "このキーを削除しますか？使用中のクライアントは直ちにアクセスできなくなります。この操作は元に戻せません。",
  ...
  "claudeDesktop.catalogChanged": "編集中にモデルカタログが変更されました。利用できないモデルを元に戻したので、プロファイルを確認して再度保存してください。",
  ...
  "claudeDesktop.mappingDetails": "詳細なモデルマッピング",
  ...
  "prov.cooldownCleared": "クールダウンが解除されました",
  "prov.cooldownClearFailed": "クールダウンを解除できませんでした",
  "prov.accountId": "ID",
  ...
  "sub.delegation.model": "優先サブエージェントモデル",
  "sub.delegation.modelHint": "OpenCodex が委任用に推奨するモデルです。広告するオーバーライドの順序とは独立しています。",
  ...
  "sub.routedDelegationBridgeInactive": "有効化済みです。対象となるネイティブ V2 ルートと生成された子ターンで動作します。",
  ...
  "sub.prefer": "優先にする",
  "sub.preferred": "優先",
  "sub.preferredOutsideAdvertised": "優先モデルは5つの広告オーバーライドに含まれていません。完全なIDで実行できますが、自動的には挿入されません。",
  "sub.catalogState.label": "Codex カタログ",
  "sub.catalogState.fresh": "最新",
  "sub.catalogState.stale": "古い状態 — モデルピッカーを更新するには Codex を再起動してください。",
  "sub.catalogState.not_running": "実行中の Codex app-server はありません",
  "sub.catalogState.unknown": "不明",
  "sub.nativeDefaultState.active": "有効：モデル省略のサブエージェントは同期後にこの優先設定を使用します。",
  "sub.nativeDefaultState.disabled": "モデル省略の同期は無効です。この優先設定はネイティブ既定値ではありません。",
  "sub.nativeDefaultState.pending": "保留中：モデル省略の動作を有効にするには同期または再起動が必要です。",
  "sub.nativeDefaultState.blocked": "ブロック：ユーザー所有または互換性のない Codex 設定がネイティブ同期を妨げています。",
  "logs.filter.agent.label": "エージェント",
  "logs.filter.agent.all": "すべて",
  "logs.filter.agent.main": "メイン",
  "logs.filter.agent.subagent": "サブエージェント",
  "logs.filter.agent.internal": "内部",
  "logs.filter.agent.unknown": "不明",
  "logs.agent.main": "メイン",
  "logs.agent.subagent": "サブエージェント",
  "logs.agent.internal": "内部",
  "logs.agent.unknown": "不明",
  "logs.agent.badgeTitle": "リクエストの発信元",
