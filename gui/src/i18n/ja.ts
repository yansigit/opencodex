...
"common.discard": "破棄",
  ...
  "dash.serverLoopbackCardDesc": "プロキシは 127.0.0.1 で待受します。リモートの Codex マシンからは SSH トンネル経由で接続します。",
  "dash.serverLoopbackCardNote": "Codex マシン側で openai_base_url をフォワーディング先 URL に設定し、設定済みの場合は x-opencodex-api-key も渡してください。UnknownIssuer を完全に回避できます。",
