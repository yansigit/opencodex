...
"common.discard": "Verwerfen",
  ...
  "auth.adminTokenDesc": "Gib dein OPENCODEX_ADMIN_AUTH_TOKEN ein, um fortzufahren. Dein Browser kann es für das nächste Mal speichern.",
  "auth.adminTokenPlaceholder": "Admin-Token einfügen",
  "auth.adminTokenShow": "Anzeigen",
  "auth.adminTokenHide": "Verbergen",
  ...
  "dash.activity.title": "Aktivität der letzten 30 Tage",
  "dash.activity.requests": "Anfragen",
  "dash.activity.tokens": "Token",
  "dash.activity.chartLabel": "Aktivität der letzten 30 Tage. Mit Links und Rechts einen Tag auswählen; Pos1 und Ende springen zu den Bereichsgrenzen.",
  "dash.activity.viewUsage": "Nutzung anzeigen",
  ...
  "dash.connectionReconnecting": "Verbindung unterbrochen — erneuter Verbindungsaufbau…",
  ...
  "dash.serverModeLabel": "Fernzugriffsmodus",
  "dash.serverModeLoopback": "Loopback + SSH",
  "dash.serverModeRemote": "Remote TLS",
  "dash.serverModeLoopbackHint": "Für LAN empfohlen. Behält 127.0.0.1 bei und nutzt SSH-Weiterleitung – keine Zertifikatsvertrauensstellung nötig.",
  "dash.serverModeRemoteHint": "Direkter TLS-Bind (0.0.0.0). Erfordert ein vertrauenswürdiges Zertifikat.",
  "dash.serverLoopbackCardTitle": "Loopback – SSH-Weiterleitung",
  "dash.serverLoopbackCardDesc": "Führen Sie auf dem Computer, auf dem Sie das Dashboard öffnen möchten, diesen temporären Tunnel aus und lassen Sie das Terminal geöffnet.",
  "dash.serverLoopbackCardNote": "Öffnen Sie die weitergeleitete HTTP-URL im Browser. SSH verschlüsselt die Verbindung; verwenden Sie niemals ssh -g.",
  "dash.serverPersistentTunnelDocs": "Dauerhaften macOS-Tunnel einrichten",
  "dash.serverRemoteCardTitle": "Remote-TLS-Bind",
  "dash.serverRemoteCardDesc": "Proxy lauscht auf allen Schnittstellen mit TLS. Codex verbindet sich direkt mit https://<host>:<port>. Das Zertifikat muss vom Codex-Rechner (rustls) vertraut werden – ein selbstsigniertes Zertifikat zeigt UnknownIssuer bis zur Installation.",
  "dash.serverRemoteSanHint": "Das Zertifikat-SAN muss den Hostnamen oder die IP aus publicOrigin enthalten. Verwende eine vertrauenswürdige CA oder installiere deine private CA auf dem Codex-Rechner.",
  "dash.serverAdvanced": "Erweitert (Hostname)",
  "dash.serverCopyUnavailable": "Kopieren nicht verfügbar",
  "dash.serverRemoteCredentialRequired": "Füge vor dem Aktivieren von Remote-TLS einen Data-Plane-API-Schlüssel hinzu.",
  "dash.serverRestartNotice": "Listener-Änderungen gespeichert. Starte den Proxy neu, um sie anzuwenden.",
  "dash.serverSettingsTitle": "Einstellungen des Server-Listeners",
  "dash.serverSaveFailed": "Server-Listener-Einstellungen konnten nicht gespeichert werden.",
  "dash.serverTlsOff": "deaktiviert",
  "dash.serverCredentialConfigured": "konfiguriert",
  "dash.serverCredentialMissing": "fehlt",
  "dash.serverRestartRequired": "ja",
  ...
  "dash.syncCodexSubagentDefaults": "Für Sub-Agenten ohne Modell verwenden",
  ...
  "prov.cooldownCleared": "Abklingzeit gelöscht",
  "prov.cooldownClearFailed": "Abklingzeit konnte nicht gelöscht werden",
  "prov.accountId": "ID",
  ...
  "models.contextCapLabel": "Sicherheitslimit / Fallback",
  ...
  "models.contextDefault": "Sicherheitslimit / Fallback",
  "models.contextModel": "Modell",
  "models.contextModelOverride": "Modellüberschreibung",
  "models.contextHint": "Leer lassen für automatische Erkennung. Ein Wert hier ist ein Sicherheitslimit und Fallback: er füllt ein fehlendes Upstream-Fenster und senkt nur ein größeres gemeldetes. Live-Erkennung wird nie in dieses Feld geschrieben.",
  ...
  "models.contextMetadataUnknown": "unbekannt",
  "models.contextMetadataStale": "veraltet",
  "models.contextTooltipDetected": "{value} · erkannt",
  "models.contextTooltipCapped": "{detected} erkannt · begrenzt auf {cap}",
  "models.contextTooltipStale": "{value} · {when}",
  "models.contextTooltipUnknown": "Kontextfenster unbekannt",
  "models.contextTooltipSource": "{value} · {source}",
  "models.contextLastChecked": "zuletzt geprüft {when}",
  "models.contextYesterday": "gestern",
  ...
  "models.customEditNamed": "{name} bearbeiten",
  "models.customDeleteNamed": "{name} löschen",
  ...
  "sub.orderHint": "Die Reihenfolge bestimmt nur die Modelle, die {cmd} anzeigt, nicht Standard- oder Fallback-Reihenfolge.",
  "sub.orderHintAria": "Wie diese Reihenfolge verwendet wird",
  "sub.advanced": "Erweitert",
  "sub.featured": "Angekündigte Überschreibungen",
  ...
  "sub.workspace.addToFeatured": "{m} zu den angekündigten Überschreibungen hinzufügen",
  "sub.workspace.allModels": "Alle Modelle",
  "sub.workspace.featuredFull": "Liste der angekündigten Überschreibungen ist voll (max. 5)",
  ...
  "sub.workspace.removeFromFeatured": "{m} aus den angekündigten Überschreibungen entfernen",
  ...
  "sub.nativeParentOverride": "Native V2-Eltern weiterleiten",
  "sub.nativeParentOverrideHint": "Codex kann das ursprüngliche native Modell anzeigen, während OpenCodex den Root auf dem ausgewählten weitergeleiteten Ziel ausführt.",
  "sub.nativeParentOverridePrivacyWarning": "Prompts, Repository-Kontext, Gesprächsverlauf und Tool-Ergebnisse gehen an den ausgewählten Anbieter und übernehmen dessen Verfügbarkeit, Kontext, Latenz, Verhalten, Kosten und Datenschutzeigenschaften.",
  ...
  "sub.agentTaskRecovery": "Verschlüsselte V2-Aufgaben wiederherstellen",
  "sub.agentTaskRecoveryHint": "Entschlüsselt OpenAI Fernet-verschlüsselte Aufgaben über ChatGPT, damit Nicht-OpenAI-Subagenten weitergeleitete V2-Aufgaben lesen können.",
  "sub.agentTaskRecoveryModel": "Wiederherstellungsmodell (Standard: gpt-5.6-luna)",
  "sub.agentTaskRecoveryDefault": "Standardmodell (gpt-5.6-luna)",
  "sub.agentTaskRecoverySaveFail": "Wiederherstellung verschlüsselter Aufgaben konnte nicht gespeichert werden",
  "sub.agentTaskRecoverySaved": "Einstellung für die Wiederherstellung verschlüsselter Aufgaben gespeichert.",
  "sub.roles": "Rollen",
  ...
  "sub.roles.empty": "Noch keine Rollen. Fügen Sie einen Spezialisten für Review, Suche oder andere delegierte Arbeit hinzu.",
  "sub.roles.full": "Rollenkatalog ist voll (max. 8)",
  "sub.roles.id": "Rollenname",
  "sub.roles.description": "Wann verwenden",
  "sub.roles.descriptionHint": "Wird dem Eltern-Agent gezeigt, damit es weiß, wann dieser Spezialist gespawnt werden soll.",
  "sub.roles.model": "Modell",
  "sub.roles.effort": "Aufwand",
  "sub.roles.effortNone": "Modellstandard",
  "sub.roles.instructions": "Kind-Anweisungen",
  "sub.roles.instructionsHint": "Developer-Prompt, den das Kind-Agent lädt.",
  "sub.roles.enabled": "Aktiv",
  "sub.roles.delete": "Rolle {id} löschen",
  "sub.roles.save": "Rollen speichern",
  "sub.roles.saved": "Rollen gespeichert. Gilt für neue Codex-Sitzungen.",
  "sub.roles.saveFailed": "Rollen konnten nicht gespeichert werden",
  "sub.roles.loadFail": "Rollen konnten nicht geladen werden — läuft der Proxy?",
  "sub.roles.routedV2Warning": "Diese Rolle nutzt ein geroutetes Modell auf der v2-Oberfläche, ohne ChatGPT auf v1 zu halten. Native v2-Eltern verschlüsseln Kind-Aufgaben.",
  "sub.roles.sync": "Mit Codex-Agent-Dateien synchronisieren",
  "sub.roles.syncHint": "Schreibt aktivierte Rollen in marker-eigene ocx-*.toml-Dateien. Aus bereinigt OpenCodex-eigene Dateien und lässt Ihre unangetastet.",
  "sub.injectionPrompt": "Benutzerdefinierte Eltern-Anleitung",
  "sub.injectionPromptHint": "Ersetzt den eingebauten v2-Spawn-Hinweis. Leer lassen für den Standardtext. Platzhalter einfügen, wenn Live-Werte nötig sind:",
  "sub.injectionPromptSave": "Eltern-Anleitung speichern",
  "sub.injectionPromptSaved": "Eltern-Anleitung gespeichert. Gilt für neue Codex-Sitzungen.",
  "sub.injectionPromptSaveFailed": "Eltern-Anleitung konnte nicht gespeichert werden",
  "sub.childInstructions": "Globale Kind-Anweisungen",
  "sub.childInstructionsHint": "Gilt für jedes gespawnte Kind. Rollenanweisungen gelten nach der Synchronisierung nur für diesen Spezialisten.",
  "sub.childInstructionsSave": "Kind-Anweisungen speichern",
  "sub.childInstructionsSaved": "Kind-Anweisungen gespeichert. Gilt für neue Codex-Sitzungen.",
  "sub.childInstructionsSaveFailed": "Kind-Anweisungen konnten nicht gespeichert werden",
  ...
  "logs.filter.time.all": "Gesamte Zeit",
  "logs.filter.time.15m": "Letzte 15 Min",
  "logs.filter.time.1h": "Letzte 1 Std",
  ...
  "logs.filter.showingCount": "Zeige {count} von {total}",
 ...
 "logs.filter.conversation.clear": "Löschen",
  ...
  "logs.detail.attempt.recovery.cursorEnvelopeEcho": "Wiederherstellung nach Cursor-Replay-Hülle",
  "logs.detail.attempt.recovery.cursorRoutingCommentary": "Wiederherstellung nach Cursor-Routing-Kommentar",
  "logs.detail.attempt.recovery.cursorDuplicateToolCall": "Wiederherstellung nach doppeltem Cursor-Tool-Aufruf",
  "logs.detail.attempt.recovery.cursorOverflowRemint": "Cursor-Überlaufwiederherstellung",
  "logs.detail.attempt.recovery.cursorInvalidArgument": "Cursor-Wiederherstellung nach ungültigem Argument",
...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
  ...
  "anthropicPool.disabledDesc": "Ein Konto pro Sitzung. 429-Failover ist ausgeschaltet.",
  ...
  "api.workspace.deleteConfirm": "Diesen Schlüssel löschen? Clients, die ihn verwenden, verlieren sofort den Zugriff. Das lässt sich nicht rückgängig machen.",
  ...
  "replitGateway.title": "Replit-Gateway-Begleiter",
  "replitGateway.subtitle": "Verbinden Sie Ihr selbst bereitgestelltes Replit-Gateway und installieren Sie die gepaarten OpenAI-Chat- und Anthropic-Anbieter gemeinsam.",
  "replitGateway.companionNote": "Dies ist ein benutzerdefinierter Begleit-Workflow, kein kanonisches Registry-Preset.",
  "replitGateway.originLabel": "Bereitstellungs-Ursprung",
  "replitGateway.originHint": "HTTPS-Ursprung Ihrer Replit-Bereitstellung (z. B. https://my-app.replit.app).",
  "replitGateway.keyLabel": "Gateway-Schlüssel",
  "replitGateway.keyHint": "Das REPLIT_GATEWAY_KEY-Geheimnis aus Ihrer Bereitstellung. Es wird in Ihrer lokalen Anbieterkonfiguration gespeichert und authentifiziert den Gateway-Datenverkehr.",
  "replitGateway.keyTooShort": "Der Gateway-Schlüssel ist zu kurz (mindestens 32 Zeichen).",
  "replitGateway.keyTooLong": "Der Gateway-Schlüssel darf höchstens 512 Zeichen lang sein.",
  "replitGateway.keyInvalidChars": "Der Gateway-Schlüssel darf nur druckbare ASCII-Zeichen enthalten.",
  "replitGateway.errorNetwork": "Der Proxy konnte nicht erreicht werden. Prüfen Sie, ob er läuft, und versuchen Sie es erneut.",
  "replitGateway.errorMalformed": "Der Proxy hat eine ungültige Antwort zurückgegeben. Versuchen Sie es in Kürze erneut.",
  "replitGateway.customDomainLabel": "Benutzerdefinierte Domain zulassen",
  "replitGateway.customDomainHint": "Nur aktivieren, wenn Ihr Gateway nicht auf .replit.app gehostet wird.",
  "replitGateway.setDefaultLabel": "replit nach der Installation als Standardanbieter festlegen",
  "replitGateway.install": "Paar installieren",
  "replitGateway.installing": "Installation…",
  "replitGateway.close": "Schließen",
  "replitGateway.openButton": "Replit-Gateway…",
  "replitGateway.replaceTitle": "Bestehendes Replit-Paar ersetzen?",
  "replitGateway.replaceBody": "Die Anbieter replit und replit-anthropic existieren bereits. Beim Ersetzen werden Gateway-Ursprung und Schlüssel überschrieben; Ihre Overlays bleiben erhalten.",
  "replitGateway.replaceConfirm": "Paar ersetzen",
  "replitGateway.replaceCancel": "Bestehendes behalten",
  "replitGateway.probeHealth": "healthz: HTTP {status} ({ms} ms)",
  "replitGateway.probeModels": "models: {count} gefunden ({ms} ms)",
  "replitGateway.successTitle": "Das Replit-Gateway-Paar wurde installiert.",
  "replitGateway.errorGeneric": "Das Replit-Gateway-Paar konnte nicht installiert werden.",
  "replitGateway.errorCollision": "Das Replit-Anbieterpaar existiert bereits.",
  "replitGateway.errorBusy": "Die Konfiguration ist ausgelastet. Versuchen Sie es in Kürze erneut.",
  "replitGateway.originRequired": "Der Bereitstellungs-Ursprung ist erforderlich.",
  "replitGateway.keyRequired": "Der Gateway-Schlüssel ist erforderlich.",
  ...
  "modal.catalogLoadFailed": "Anbieterkatalog konnte nicht geladen werden.",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "pws.clearCooldown": "Abklingzeit löschen",
  ...
  "pws.antigravityTlsTitle": "Antigravity-Browser-TLS-Profil",
  "pws.antigravityTlsEnable": "Experimentelle TLS/HTTP2-Emulation aktivieren",
  "pws.antigravityTlsWarning": "Inoffizielle Kompatibilitätsfunktion. Sie gewährleistet keine Einhaltung der Nutzungsbedingungen und verhindert keine Sperrung, kann den Datenverkehr auffälliger machen und bei Initialisierungsfehlern auf Bun zurückfallen. Offizielle Gemini-API-Key-, Vertex- oder dokumentierte Code-Assist-Routen sind sicherere Optionen.",
  "pws.antigravityTlsConfirm": "Das experimentelle, inoffizielle Antigravity-TLS-Profil aktivieren? Es gewährleistet keine Richtlinienkonformität und verhindert keine Sperrung. Fortfahren?",
  "pws.antigravityTlsStatus": "TLS-Profilstatus: {status}",
  "pws.antigravityTlsDisabled": "Deaktiviert",
  "pws.antigravityTlsActive": "Aktiv",
  "pws.antigravityTlsFallback": "Fallback",
  ...
  "pws.aiStudio.connected": "Verbunden",
  "pws.aiStudio.checking": "Sitzung wird geprüft",
  "pws.aiStudio.unsupported": "Native Anmeldung auf dieser Plattform nicht unterstützt",
  "pws.aiStudio.needsReauth": "Erneute Anmeldung erforderlich",
  "pws.aiStudio.reauthenticated": "Erfolgreich erneut angemeldet",
  "pws.aiStudio.loginFailed": "Native Anmeldung fehlgeschlagen",
  "pws.aiStudio.connect": "Verbinden",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "claudeDesktop.catalogChanged": "Der Modellkatalog hat sich während der Bearbeitung geändert. Das nicht verfügbare Modell wurde wiederhergestellt; prüfen Sie das Profil und speichern Sie erneut.",
  ...
  "claudeDesktop.mappingDetails": "Erweiterte Modellzuordnungen",
  ...
  "sub.delegation.model": "Bevorzugtes Sub-Agent-Modell",
  "sub.delegation.modelHint": "Das Modell, das OpenCodex für Delegation empfiehlt. Es ist unabhängig von der Reihenfolge der angekündigten Überschreibungen.",
  ...
  "sub.routedDelegationBridgeInactive": "Bereitgestellt; wird für geeignete native V2-Roots und gespawnte Kind-Turns aktiviert.",
  ...
  "sub.prefer": "Bevorzugen",
  "sub.preferred": "Bevorzugt",
  "sub.preferredOutsideAdvertised": "Das bevorzugte Modell ist nicht in den fünf angekündigten Überschreibungen. Es bleibt über seine vollständige ID ausführbar und wird nicht automatisch eingefügt.",
  "sub.catalogState.label": "Codex-Katalog",
  "sub.catalogState.fresh": "Aktuell",
  "sub.catalogState.stale": "Veraltet — starte Codex neu, um die Modellauswahl zu aktualisieren.",
  "sub.catalogState.not_running": "Kein Codex-App-Server aktiv",
  "sub.catalogState.unknown": "Unbekannt",
  "sub.nativeDefaultState.active": "Aktiv: Sub-Agenten ohne Modell verwenden diese Präferenz nach der Synchronisierung.",
  "sub.nativeDefaultState.disabled": "Synchronisierung für Sub-Agenten ohne Modell ist deaktiviert; diese Präferenz ist kein natives Standardmodell.",
  "sub.nativeDefaultState.pending": "Ausstehend: Synchronisierung oder Neustart erforderlich, bevor das Verhalten aktiv ist.",
  "sub.nativeDefaultState.blocked": "Blockiert: Eine benutzereigene oder inkompatible Codex-Einstellung verhindert die native Synchronisierung.",
  "logs.filter.agent.label": "Agent",
  "logs.filter.agent.all": "Alle",
  "logs.filter.agent.main": "Hauptagent",
  "logs.filter.agent.subagent": "Sub-Agent",
  "logs.filter.agent.internal": "Intern",
  "logs.filter.agent.unknown": "Unbekannt",
  "logs.agent.main": "Hauptagent",
  "logs.agent.subagent": "Sub-Agent",
  "logs.agent.internal": "Intern",
  "logs.agent.unknown": "Unbekannt",
  "logs.agent.badgeTitle": "Anfrageherkunft",
