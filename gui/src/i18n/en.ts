...
"common.discard": "Discard",
  ...
  "auth.adminTokenDesc": "Enter your OPENCODEX_ADMIN_AUTH_TOKEN to continue. Your browser may offer to save it for next time.",
  ...
  "dash.connectionReconnecting": "Connection interrupted — reconnecting…",
  ...
  "dash.serverSettingsTitle": "Server listener settings",
  "dash.serverModeLabel": "Remote access mode",
  "dash.serverModeLoopback": "Loopback + SSH",
  "dash.serverModeRemote": "Remote TLS",
  "dash.serverModeLoopbackHint": "Recommended for LAN. Keep 127.0.0.1 and use SSH forwarding — no certificate trust needed.",
  "dash.serverModeRemoteHint": "Direct TLS bind (0.0.0.0). Requires a trusted certificate.",
  "dash.serverLoopbackCardTitle": "Loopback — SSH forwarding",
  "dash.serverLoopbackCardDesc": "On the computer where you want to open the dashboard, run this temporary tunnel and keep the terminal open.",
  "dash.serverLoopbackCardNote": "Open the forwarded HTTP URL in your browser. SSH encrypts the connection; never use ssh -g.",
  "dash.serverPersistentTunnelDocs": "Persistent macOS tunnel setup",
  "dash.serverRemoteCardTitle": "Remote TLS bind",
  "dash.serverRemoteCardDesc": "Proxy listens on all interfaces with TLS. Codex connects directly to https://<host>:<port>. The certificate must be trusted by the Codex machine (rustls) — a self-signed cert will show UnknownIssuer until installed.",
  "dash.serverRemoteSanHint": "The certificate SAN must include the hostname or IP in publicOrigin. Use a trusted CA or install your private CA on the Codex machine.",
  "dash.serverAdvanced": "Advanced (hostname)",
  "dash.serverCopyUnavailable": "Copy unavailable",
  "dash.serverRemoteCredentialRequired": "Add a data-plane API key before enabling remote TLS.",
  "dash.serverRestartNotice": "Listener changes are saved. Restart the proxy to apply them.",
  "dash.serverSaveFailed": "Failed to save server listener settings.",
  "dash.serverTlsOff": "off",
  "dash.serverCredentialConfigured": "configured",
  "dash.serverCredentialMissing": "missing",
  "dash.serverRestartRequired": "true",
  ...
  "prov.cooldownCleared": "Cooldown cleared",
  "prov.cooldownClearFailed": "Could not clear cooldown",
  "prov.accountId": "ID",
  ...
  "models.contextCapLabel": "Safety cap / fallback",
  ...
  "models.contextDefault": "Safety cap / fallback",
  "models.contextModel": "Model",
  "models.contextModelOverride": "Model override",
  "models.contextHint": "Leave blank for automatic discovery. A value here is a safety cap and fallback: it fills a missing upstream window and only lowers a larger reported one. Live discovery is never written into this field.",
  ...
  "models.contextMetadataUnknown": "unknown",
  "models.contextMetadataStale": "stale",
  "models.contextTooltipDetected": "{value} · detected",
  "models.contextTooltipCapped": "{detected} detected · capped at {cap}",
  "models.contextTooltipStale": "{value} · {when}",
  "models.contextTooltipUnknown": "Context window unknown",
  "models.contextTooltipSource": "{value} · {source}",
  "models.contextLastChecked": "last checked {when}",
  "models.contextYesterday": "yesterday",
  ...
  "sub.featured": "Advertised overrides",
  "sub.orderHint": "Order controls the models shown by {cmd}; it does not set a default or fallback order.",
  ...
  "sub.delegation.model": "Preferred subagent model",
  "sub.delegation.modelHint": "The model OpenCodex recommends for delegation. It is independent of the advertised override order.",
  "sub.prefer": "Prefer",
  ...
  "sub.workspace.addToFeatured": "Add {m} to advertised overrides",
  "sub.workspace.allModels": "All models",
  "sub.workspace.featuredFull": "Advertised override list is full (max 5)",
  ...
  "sub.nativeParentOverride": "Route native V2 parents",
  "sub.nativeParentOverrideHint": "Codex may display the original native model while OpenCodex executes the root on the selected routed target.",
  "sub.nativeParentOverridePrivacyWarning": "Prompts, repository context, conversation history, and tool results go to the selected provider and inherit its availability, context, latency, behavior, cost, and privacy characteristics.",
  ...
  "sub.routedDelegationBridgeInactive": "Armed; activates for eligible native V2 roots and spawned-child turns.",
  ...
  "sub.agentTaskRecovery": "Recover Encrypted V2 Tasks",
  "sub.agentTaskRecoveryHint": "Unwraps OpenAI Fernet-encrypted task messages via ChatGPT so non-OpenAI subagents can read and execute routed V2 tasks.",
  "sub.agentTaskRecoveryModel": "Recovery model (default: gpt-5.6-luna)",
  "sub.agentTaskRecoveryDefault": "Model default (gpt-5.6-luna)",
  "sub.agentTaskRecoverySaveFail": "Failed to save encrypted task recovery",
  "sub.agentTaskRecoverySaved": "Encrypted task recovery setting saved.",
  "sub.roles": "Roles",
  ...
  "sub.roles.empty": "No roles yet. Add a specialist for review, search, or other delegated work.",
  "sub.roles.full": "Role catalog is full (max 8)",
  "sub.roles.id": "Role name",
  "sub.roles.description": "When to use",
  "sub.roles.descriptionHint": "Shown to the parent so it knows when to spawn this specialist.",
  "sub.roles.model": "Model",
  "sub.roles.effort": "Effort",
  "sub.roles.effortNone": "Model default",
  "sub.roles.instructions": "Child instructions",
  "sub.roles.instructionsHint": "Developer prompt the child agent loads.",
  "sub.roles.enabled": "Enabled",
  "sub.roles.delete": "Delete role {id}",
  "sub.roles.save": "Save roles",
  "sub.roles.saved": "Roles saved. Applies to new Codex sessions.",
  "sub.roles.saveFailed": "Failed to save roles",
  "sub.roles.loadFail": "Failed to load roles — is the proxy running?",
  "sub.roles.routedV2Warning": "This role uses a routed model on the v2 surface without keeping ChatGPT on v1. Native v2 parents encrypt child tasks.",
  "sub.roles.sync": "Sync to Codex agent files",
  "sub.roles.syncHint": "Write enabled roles to marker-owned ocx-*.toml files. Off prunes OpenCodex-owned files and leaves yours untouched.",
  "sub.injectionPrompt": "Custom parent guidance",
  "sub.injectionPromptHint": "Replaces the built-in v2 spawn advice. Leave empty for the built-in text. Include placeholders if you want live values:",
  "sub.injectionPromptSave": "Save parent guidance",
  "sub.injectionPromptSaved": "Parent guidance saved. Applies to new Codex sessions.",
  "sub.injectionPromptSaveFailed": "Failed to save parent guidance",
  "sub.childInstructions": "Global child instructions",
  "sub.childInstructionsHint": "Applies to every spawned child. Named role instructions, when synced to Codex, apply only to that specialist.",
  "sub.childInstructionsSave": "Save child instructions",
  "sub.childInstructionsSaved": "Child instructions saved. Applies to new Codex sessions.",
  "sub.childInstructionsSaveFailed": "Failed to save child instructions",
  "sub.workspace.removeFromFeatured": "Remove {m} from advertised overrides",
 ...
 "logs.filter.conversation.clear": "Clear",
  ...
  "logs.detail.attempt.recovery.cursorEnvelopeEcho": "Cursor replay envelope recovery",
  "logs.detail.attempt.recovery.cursorRoutingCommentary": "Cursor routing commentary recovery",
  "logs.detail.attempt.recovery.cursorDuplicateToolCall": "Cursor duplicate tool-call recovery",
  "logs.detail.attempt.recovery.cursorOverflowRemint": "Cursor overflow conversation recovery",
  "logs.detail.attempt.recovery.cursorInvalidArgument": "Cursor invalid-argument recovery",
  ...
  "replitGateway.title": "Replit gateway companion",
  "replitGateway.subtitle": "Connect your user-deployed Replit gateway and install the paired OpenAI Chat and Anthropic providers together.",
  "replitGateway.companionNote": "This is a custom companion workflow, not a canonical registry preset.",
  "replitGateway.originLabel": "Deployment origin",
  "replitGateway.originHint": "HTTPS origin of your Replit deployment (for example https://my-app.replit.app).",
  "replitGateway.keyLabel": "Gateway key",
  "replitGateway.keyHint": "The REPLIT_GATEWAY_KEY secret from your deployment. It is stored in your local provider configuration and used to authenticate gateway traffic.",
  "replitGateway.keyTooShort": "Gateway key is too short (minimum 32 characters).",
  "replitGateway.keyTooLong": "Gateway key must be at most 512 characters.",
  "replitGateway.keyInvalidChars": "Gateway key must contain only printable ASCII characters.",
  "replitGateway.errorNetwork": "Could not reach the proxy. Check that it is running and try again.",
  "replitGateway.errorMalformed": "The proxy returned an invalid response. Try again shortly.",
  "replitGateway.customDomainLabel": "Allow custom domain",
  "replitGateway.customDomainHint": "Only enable when your gateway is not hosted on .replit.app.",
  "replitGateway.setDefaultLabel": "Set replit as the default provider after install",
  "replitGateway.install": "Install pair",
  "replitGateway.installing": "Installing…",
  "replitGateway.close": "Close",
  "replitGateway.openButton": "Replit gateway…",
  "replitGateway.replaceTitle": "Replace the existing Replit pair?",
  "replitGateway.replaceBody": "Providers replit and replit-anthropic already exist. Replacing overwrites the gateway origin and key while preserving your overlays.",
  "replitGateway.replaceConfirm": "Replace pair",
  "replitGateway.replaceCancel": "Keep existing",
  "replitGateway.probeHealth": "healthz: HTTP {status} ({ms} ms)",
  "replitGateway.probeModels": "models: {count} discovered ({ms} ms)",
  "replitGateway.successTitle": "Installed the Replit gateway pair.",
  "replitGateway.errorGeneric": "Could not install the Replit gateway pair.",
  "replitGateway.errorCollision": "The Replit provider pair already exists.",
  "replitGateway.errorBusy": "Configuration is busy. Retry shortly.",
  "replitGateway.originRequired": "Deployment origin is required.",
  "replitGateway.keyRequired": "Gateway key is required.",
  ...
  "modal.catalogLoadFailed": "Could not load provider catalog.",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.clearCooldown": "Clear cooldown",
  ...
  "pws.antigravityTlsTitle": "Antigravity browser TLS profile",
  "pws.antigravityTlsEnable": "Enable experimental TLS/HTTP2 emulation",
  "pws.antigravityTlsWarning": "Unofficial compatibility behavior. It does not ensure Terms-of-Service compliance or prevent suspension, may make traffic more distinctive, and can fall back to Bun when initialization fails. Official Gemini API-key, Vertex, or documented Code Assist routes are safer choices.",
  "pws.antigravityTlsConfirm": "Enable the experimental unofficial Antigravity TLS profile? It does not ensure policy compliance or prevent suspension and may make traffic more distinctive. Continue?",
  "pws.antigravityTlsStatus": "TLS profile status: {status}",
  "pws.antigravityTlsDisabled": "Disabled",
  "pws.antigravityTlsActive": "Active",
  ...
  "pws.aiStudio.connected": "Connected",
  "pws.aiStudio.checking": "Checking session",
  "pws.aiStudio.unsupported": "Native login unsupported on this platform",
  "pws.aiStudio.needsReauth": "Reauthentication required",
  "pws.aiStudio.reauthenticated": "Reauthenticated successfully",
  "pws.aiStudio.loginFailed": "Native login failed",
...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "api.workspace.deleteConfirm": "Delete this key? Clients using it will immediately lose access. This cannot be undone.",
  ...
  "claudeDesktop.catalogChanged": "The model catalog changed while you were editing. The unavailable model was restored; review the profile and save again.",
  ...
  "claudeDesktop.mappingDetails": "Advanced model mappings",
