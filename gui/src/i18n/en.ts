...
"common.discard": "Discard",
  ...
  "dash.serverLoopbackCardDesc": "Proxy stays on 127.0.0.1. Connect from the remote Codex machine via SSH tunnel.",
  "dash.serverLoopbackCardNote": "On the Codex machine set openai_base_url to the forwarded URL and pass x-opencodex-api-key if configured. Avoids UnknownIssuer entirely.",
