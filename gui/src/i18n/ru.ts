...
export const ru: Record<TKey, string> = {
  ...
  "pws.aiStudio.relayActive": "Browser relay active",
  "pws.aiStudio.sessionActive": "Session active",
  "pws.aiStudio.disconnected": "Disconnected",
  "pws.aiStudio.connect": "Connect",
