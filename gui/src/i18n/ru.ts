...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "sub.prefer": "Prefer",
  "sub.preferred": "Preferred",
  "sub.preferredOutsideAdvertised": "The preferred model is not in the five advertised overrides. It remains executable by exact id and is not inserted automatically.",
  "sub.catalogState.label": "Codex catalog",
  "sub.catalogState.fresh": "Fresh",
  "sub.catalogState.stale": "Stale — restart Codex to refresh its model picker.",
  "sub.catalogState.not_running": "No Codex app-server running",
  "sub.catalogState.unknown": "Unknown",
  "sub.nativeDefaultState.active": "Live: omitted-model subagents use this preference after sync.",
  "sub.nativeDefaultState.disabled": "Omitted-model sync is off; this preference is not a native default.",
  "sub.nativeDefaultState.pending": "Pending: sync/restart is required before omitted-model behavior is live.",
  "sub.nativeDefaultState.blocked": "Blocked: a user-owned or incompatible Codex setting prevents native sync.",
  "logs.filter.agent.label": "Agent",
  "logs.filter.agent.all": "All",
  "logs.filter.agent.main": "Main",
  "logs.filter.agent.subagent": "Subagent",
  "logs.filter.agent.internal": "Internal",
  "logs.filter.agent.unknown": "Unknown",
  "logs.agent.main": "Main",
  "logs.agent.subagent": "Subagent",
  "logs.agent.internal": "Internal",
  "logs.agent.unknown": "Unknown",
  "logs.agent.badgeTitle": "Request origin",
};
