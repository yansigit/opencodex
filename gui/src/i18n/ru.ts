...
"common.discard": "Отбросить",
  ...
  "dash.serverLoopbackCardDesc": "Прокси остаётся на 127.0.0.1. Подключайтесь с удалённой машины Codex через SSH-туннель.",
  "dash.serverLoopbackCardNote": "На машине Codex укажите openai_base_url на адрес проброса и передайте x-opencodex-api-key, если он настроен. Полностью избегает ошибки UnknownIssuer.",
