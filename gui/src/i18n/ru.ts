...
"common.discard": "Отбросить",
  ...
  "auth.adminTokenDesc": "Enter your OPENCODEX_ADMIN_AUTH_TOKEN to continue.",
  "auth.adminTokenPlaceholder": "Paste admin token",
  "auth.adminTokenShow": "Show",
  "auth.adminTokenHide": "Hide",
