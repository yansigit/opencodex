...
"common.discard": "丢弃",
  ...
  "auth.adminTokenDesc": "输入你的 OPENCODEX_ADMIN_AUTH_TOKEN 以继续。浏览器可能会在下次为你保存。",
  "auth.adminTokenPlaceholder": "粘贴管理员令牌",
  "auth.adminTokenShow": "显示",
  "auth.adminTokenHide": "隐藏",
  ...
  "dash.activity.title": "30 天活动",
  "dash.activity.requests": "请求",
  "dash.activity.tokens": "Token",
  "dash.activity.chartLabel": "30 天活动。使用左右方向键选择日期，使用 Home 和 End 跳转到范围两端。",
  "dash.activity.viewUsage": "查看用量",
  ...
  "dash.connectionReconnecting": "连接中断 — 正在重新连接…",
  ...
  "dash.serverModeLabel": "远程访问模式",
  "dash.serverModeLoopback": "回环 + SSH",
  "dash.serverModeRemote": "远程 TLS",
  "dash.serverModeLoopbackHint": "推荐用于局域网。保持 127.0.0.1 并通过 SSH 转发连接，无需证书信任配置。",
  "dash.serverModeRemoteHint": "直接 TLS 绑定（0.0.0.0），需要受信任的证书。",
  "dash.serverLoopbackCardTitle": "回环 — SSH 转发",
  "dash.serverLoopbackCardDesc": "在要打开控制台的电脑上运行此临时隧道，并保持终端窗口开启。",
  "dash.serverLoopbackCardNote": "在浏览器中打开转发后的 HTTP URL。SSH 会加密连接；切勿使用 ssh -g。",
  "dash.serverPersistentTunnelDocs": "设置永久 macOS 隧道",
  "dash.serverRemoteCardTitle": "远程 TLS 绑定",
  "dash.serverRemoteCardDesc": "代理通过 TLS 在所有网卡上监听。Codex 直接连接 https://<host>:<port>。证书须被 Codex 机器（rustls）信任，自签名证书在安装前会显示 UnknownIssuer。",
  "dash.serverRemoteSanHint": "证书 SAN 须包含 publicOrigin 中的主机名或 IP。请使用受信任的 CA，或在 Codex 机器上安装私有 CA。",
  "dash.serverAdvanced": "高级（主机名）",
  "dash.serverCopyUnavailable": "无法复制",
  "dash.serverRemoteCredentialRequired": "启用远程 TLS 前请先添加数据面 API 密钥。",
  "dash.serverRestartNotice": "监听器设置已保存，重启代理后生效。",
  "dash.serverSettingsTitle": "服务器监听器设置",
  "dash.serverSaveFailed": "保存服务器监听器设置失败。",
  "dash.serverTlsOff": "关闭",
  "dash.serverCredentialConfigured": "已配置",
  "dash.serverCredentialMissing": "缺失",
  "dash.serverRestartRequired": "是",
  "dash.injectionLabel": "子代理委托",
  "dash.injectionHint": "选择 Codex 把子任务交给谁来做的模型。这个选择用在哪里，由下面两个开关决定。",
  "dash.syncCodexSubagentDefaults": "用于省略模型的子代理",
  ...
  "prov.cooldownCleared": "已清除冷却",
  "prov.cooldownClearFailed": "清除冷却失败",
  "prov.accountId": "ID",
  ...
  "models.contextHint": "留空即自动发现。这里填写的是安全上限和回退：只在上游没有窗口时补上，并且只压低更大的上报值。实时发现的结果不会写回此栏。",
  ...
  "models.contextMetadataStale": "过期",
  "models.contextTooltipDetected": "{value} · 已检测",
  "models.contextTooltipCapped": "{detected} 已检测 · 上限 {cap}",
  "models.contextTooltipStale": "{value} · {when}",
  "models.contextTooltipUnknown": "上下文窗口未知",
  "models.contextTooltipSource": "{value} · {source}",
  "models.contextLastChecked": "上次检查 {when}",
  ...
  "sub.orderHint": "顺序只控制 {cmd} 显示的模型，不会设置默认值或回退顺序。",
  ...
  "sub.moveDown": "下移 {m}",
  "sub.removeAria": "移除 {m}",
  "sub.workspace.addToFeatured": "将 {m} 添加到公开覆盖项",
  "sub.workspace.allModels": "所有模型",
  "sub.workspace.featuredFull": "公开覆盖项列表已满（最多 5 个）",
  "sub.workspace.mainAria": "子代理模型详情",
  "sub.workspace.notFeatured": "未设为精选",
  "sub.workspace.priority": "优先级",
  "sub.workspace.removeFromFeatured": "将 {m} 从公开覆盖项中移除",
  ...
  "sub.nativeParentOverrideHint": "Codex 可能显示原始原生模型，而 OpenCodex 会在所选路由目标上执行根请求。",
  "sub.nativeParentOverridePrivacyWarning": "提示词、仓库上下文、对话历史和工具结果会发送到所选提供商，并继承其可用性、上下文、延迟、行为、成本和隐私特征。",
  ...
  "sub.agentTaskRecovery": "恢复加密的 V2 任务",
  "sub.agentTaskRecoveryHint": "通过 ChatGPT 解密 OpenAI Fernet 加密任务消息，以便非 OpenAI 子代理可以读取并执行路由的 V2 任务。",
  "sub.agentTaskRecoveryModel": "恢复模型（默认：gpt-5.6-luna）",
  "sub.agentTaskRecoveryDefault": "默认模型（gpt-5.6-luna）",
  "sub.agentTaskRecoverySaveFail": "保存加密任务恢复设置失败",
  "sub.agentTaskRecoverySaved": "加密任务恢复设置已保存。",
  "sub.roles": "角色",
  "sub.roles.hint": "父代理可以 spawn 的具名专家。每个角色固定模型和子代理提示。是否委派仍由父代理决定。",
  "sub.roles.add": "添加角色",
  "sub.roles.empty": "还没有角色。为评审、搜索或其他委派工作添加专家。",
  "sub.roles.full": "角色目录已满（最多 8 个）",
  "sub.roles.id": "角色名",
  "sub.roles.description": "何时使用",
  "sub.roles.descriptionHint": "展示给父代理，以便它知道何时 spawn 该专家。",
  "sub.roles.model": "模型",
  "sub.roles.effort": "推理强度",
  "sub.roles.effortNone": "模型默认",
  "sub.roles.instructions": "子代理说明",
  "sub.roles.instructionsHint": "子代理加载的开发者提示。",
  "sub.roles.enabled": "启用",
  "sub.roles.delete": "删除角色 {id}",
  "sub.roles.save": "保存角色",
  "sub.roles.saved": "角色已保存。适用于新的 Codex 会话。",
  "sub.roles.saveFailed": "保存角色失败",
  "sub.roles.loadFail": "无法加载角色 — 代理是否在运行？",
  "sub.roles.routedV2Warning": "此角色在 v2 表面上使用了路由模型，且未将 ChatGPT 保持在 v1。原生 v2 父会话会加密子任务。",
  "sub.roles.sync": "同步到 Codex 代理文件",
  "sub.roles.syncHint": "将已启用角色写入带标记的 ocx-*.toml。关闭时只清理 OpenCodex 拥有的文件，不改动你的文件。",
  "sub.injectionPrompt": "自定义父级指导",
  "sub.injectionPromptHint": "替换内置 v2 spawn 说明。留空则使用内置文本。若需要实时值，请加入占位符：",
  "sub.injectionPromptSave": "保存父级指导",
  "sub.injectionPromptSaved": "父级指导已保存。适用于新的 Codex 会话。",
  "sub.injectionPromptSaveFailed": "保存父级指导失败",
  "sub.childInstructions": "全局子代理说明",
  "sub.childInstructionsHint": "应用于每个被 spawn 的子代理。角色说明在同步后仅作用于该专家。",
  "sub.childInstructionsSave": "保存子代理说明",
  "sub.childInstructionsSaved": "子代理说明已保存。适用于新的 Codex 会话。",
  "sub.childInstructionsSaveFailed": "保存子代理说明失败",
  ...
  "logs.filter.showingCount": "显示 {count} / {total} 条",
 ...
 "logs.filter.conversation.clear": "清除",
  ...
  "logs.detail.attempt.recovery.cursorEnvelopeEcho": "Cursor 重放信封恢复",
  "logs.detail.attempt.recovery.cursorRoutingCommentary": "Cursor 路由解说恢复",
  "logs.detail.attempt.recovery.cursorDuplicateToolCall": "Cursor 重复工具调用恢复",
  "logs.detail.attempt.recovery.cursorOverflowRemint": "Cursor 溢出恢复",
  "logs.detail.attempt.recovery.cursorInvalidArgument": "Cursor 无效参数恢复",
...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
  ...
  "anthropicPool.disabledDesc": "每个会话仅使用一个账户。429 故障转移已关闭。",
  ...
  "api.workspace.deleteConfirm": "确定要删除此密钥吗？使用它的客户端将立即失去访问权限。此操作无法撤销。",
  ...
  "replitGateway.title": "Replit 网关配套",
  "replitGateway.subtitle": "连接您自行部署的 Replit 网关，并一起安装配对的 OpenAI Chat 与 Anthropic 提供方。",
  "replitGateway.companionNote": "这是自定义配套流程，不是规范注册表预设。",
  "replitGateway.originLabel": "部署 origin",
  "replitGateway.originHint": "Replit 部署的 HTTPS origin（例如 https://my-app.replit.app）。",
  "replitGateway.keyLabel": "网关密钥",
  "replitGateway.keyHint": "部署中的 REPLIT_GATEWAY_KEY 密钥。它会保存在本地提供方配置中，并用于网关流量认证。",
  "replitGateway.keyTooShort": "网关密钥过短（至少 32 个字符）。",
  "replitGateway.keyTooLong": "网关密钥最多 512 个字符。",
  "replitGateway.keyInvalidChars": "网关密钥只能包含可打印 ASCII 字符。",
  "replitGateway.errorNetwork": "无法连接代理。请确认其正在运行后重试。",
  "replitGateway.errorMalformed": "代理返回了无效响应。请稍后重试。",
  "replitGateway.customDomainLabel": "允许自定义域名",
  "replitGateway.customDomainHint": "仅当网关未托管在 .replit.app 上时启用。",
  "replitGateway.setDefaultLabel": "安装后将 replit 设为默认提供方",
  "replitGateway.install": "安装配对",
  "replitGateway.installing": "安装中…",
  "replitGateway.close": "关闭",
  "replitGateway.openButton": "Replit 网关…",
  "replitGateway.replaceTitle": "替换现有 Replit 配对？",
  "replitGateway.replaceBody": "提供方 replit 与 replit-anthropic 已存在。替换会覆盖网关 origin 与密钥，但会保留您的覆盖设置。",
  "replitGateway.replaceConfirm": "替换配对",
  "replitGateway.replaceCancel": "保留现有",
  "replitGateway.probeHealth": "healthz：HTTP {status}（{ms} ms）",
  "replitGateway.probeModels": "models：发现 {count} 个（{ms} ms）",
  "replitGateway.successTitle": "已安装 Replit 网关配对。",
  "replitGateway.errorGeneric": "无法安装 Replit 网关配对。",
  "replitGateway.errorCollision": "Replit 提供方配对已存在。",
  "replitGateway.errorBusy": "配置繁忙。请稍后重试。",
  "replitGateway.originRequired": "必须填写部署 origin。",
  "replitGateway.keyRequired": "必须填写网关密钥。",
  ...
  "modal.catalogLoadFailed": "无法加载提供商目录。",
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "pws.antigravityTlsTitle": "Antigravity 浏览器 TLS 配置",
  "pws.antigravityTlsEnable": "启用实验性 TLS/HTTP2 模拟",
  "pws.antigravityTlsWarning": "非官方兼容功能。它不保证遵守服务条款或避免停用，可能使流量更具特征；初始化失败时会回退到 Bun。官方 Gemini API 密钥、Vertex 或有文档的 Code Assist 路由更安全。",
  "pws.antigravityTlsConfirm": "启用实验性且非官方的 Antigravity TLS 配置？它不保证符合政策，也不能避免停用。继续吗？",
  "pws.antigravityTlsStatus": "TLS 配置状态：{status}",
  "pws.antigravityTlsDisabled": "已停用",
  "pws.antigravityTlsActive": "活动",
  ...
  "pws.aiStudio.connected": "已连接",
  "pws.aiStudio.checking": "正在检查会话",
  "pws.aiStudio.unsupported": "此平台不支持原生登录",
  "pws.aiStudio.needsReauth": "需要重新认证",
  "pws.aiStudio.reauthenticated": "重新认证成功",
  "pws.aiStudio.loginFailed": "原生登录失败",
  "pws.aiStudio.connect": "连接",
  "time.justNow": "刚刚",
  "time.notChecked": "未检查",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "claudeDesktop.catalogChanged": "编辑期间模型目录已更改。已还原不可用的模型；请检查配置后重新保存。",
  ...
  "claudeDesktop.mappingDetails": "高级模型映射",
  ...
  "sub.settings": "设置",
  "sub.sections": "子代理分区",
  "sub.delegation.model": "首选子代理模型",
  "sub.delegation.modelHint": "OpenCodex 为委派推荐的模型。它独立于公开覆盖项的顺序。",
  ...
  "sub.routedDelegationBridgeInactive": "已就绪；对符合条件的原生 V2 根任务和生成的子回合激活。",
  ...
  "sub.prefer": "设为首选",
  "sub.preferred": "首选",
  "sub.preferredOutsideAdvertised": "首选模型不在五个公开覆盖项中。它仍可通过完整 ID 执行，不会自动插入。",
  "sub.catalogState.label": "Codex 目录",
  "sub.catalogState.fresh": "最新",
  "sub.catalogState.stale": "已过期 — 重启 Codex 以刷新模型选择器。",
  "sub.catalogState.not_running": "没有正在运行的 Codex app-server",
  "sub.catalogState.unknown": "未知",
  "sub.nativeDefaultState.active": "已生效：同步后，省略模型的子代理会使用此首选项。",
  "sub.nativeDefaultState.disabled": "省略模型同步已关闭；此首选项不是原生默认值。",
  "sub.nativeDefaultState.pending": "等待中：省略模型行为生效前需要同步或重启。",
  "sub.nativeDefaultState.blocked": "已阻止：用户拥有或不兼容的 Codex 设置阻止原生同步。",
