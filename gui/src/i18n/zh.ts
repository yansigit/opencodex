...
"common.discard": "丢弃",
  ...
  "dash.serverLoopbackCardDesc": "代理仅在 127.0.0.1 上监听。请从远程 Codex 机器通过 SSH 隧道连接。",
  "dash.serverLoopbackCardNote": "在 Codex 机器上将 openai_base_url 设为转发后的 URL，如已配置则同时传递 x-opencodex-api-key。可完全避免 UnknownIssuer。",
