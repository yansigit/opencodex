    ...
    <div className="logs-filter-container">
      <div className="logs-toolbar">
        ...
        <label className="muted text-control logs-filter-field">
          ...
          <select className="input select-sm" value={filters.agentKind} aria-label={t("logs.filter.agent.label")} onChange={event => onFilterChange({ ...filters, agentKind: event.target.value as LogAgentKind })}>
