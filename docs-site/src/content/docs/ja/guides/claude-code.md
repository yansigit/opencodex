...
**2.1.201** 未満では `ocx claude` は警告のみで起動を止めません。`npm install -g @anthropic-ai/claude-code` で更新し、`ocx doctor` と `ocx status --json` で状態を確認できます。これは **2.1.129** の `/model` ピッカー機能とは別です。
