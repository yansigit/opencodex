...
| `googleMode?` | `"ai-studio" \| "vertex" \| "cloud-code-assist" \| "ai-studio-web"` | Google transport/auth mode. Default `ai-studio`. `ai-studio-web` uses the local browser relay and the active AI Studio / Google AI Pro session. |
