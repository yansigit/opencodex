      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Replit gateway companion", translations: { fr: "Compagnon passerelle Replit", ko: "Replit 게이트웨이 컴패니언", "zh-CN": "Replit 网关伴侣", "zh-TW": "Replit 閘道夥伴", ru: "Компаньон шлюза Replit", ja: "Replit ゲートウェイコンパニオン", tr: "Replit ağ geçidi eşlikçisi" }, slug: "guides/replit-gateway" },
