...
export async function multiAgentGuidanceText(
  ...
  if (surface === "v2") {
    ...
    if (injectionPrompt) {
      ...
      return `${OPENCODEX_SUBAGENT_GUIDANCE_OPEN_TAG}${applyInjectionPlaceholders(injectionPrompt, promptModel, injectionEffort, roster, fallbackGuidance, nativeDefaultState)}${OPENCODEX_SUBAGENT_GUIDANCE_CLOSE_TAG}`;
    }
