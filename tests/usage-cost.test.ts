...
describe("resolveMatchedPrice", () => {
  ...
  test("16. shipped overlay membership: 77 keys, including canonical Fable 5.1, Opus 5, Cursor, and compatibility prices", () => {
    expect(EXPECTED_PRICE_OVERLAYS.length).toBe(77);
