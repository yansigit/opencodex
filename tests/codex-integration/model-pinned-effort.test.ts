...
import { handleManagementAPI as dispatchManagementAPI } from "../../src/server/management-api";
...
function handleManagementAPI(req: Request, url: URL, config: OcxConfig) {
  return dispatchManagementAPI(req, url, config, inMemoryManagementPersistence(config));
}
